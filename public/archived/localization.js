...
function setLang(lang){
  ...
  var l = lowerLang.split('-')[0];
  if (lowerLang != 'zh-tw' && 'zh' == l)
    Localization.browserLang.langCode = 'zh';
  else
    Localization.browserLang.langCode = 'en';
  console.log('lang', lang, l, this.langCode);
}

function getString(id){
  var s = Localization.translation[Localization.browserLang][id];
  return s ? s : id;
}
